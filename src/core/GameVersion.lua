  ...
  yellow = {
    ...
    roms = {
      { locale = "us", sha1 = "cc7d03262ebfaf2f06772c1a480c7d9d5f4a38e1",
        manifest = "tools/rom_manifest_yellow.json" },
      -- Edicion Amarilla.  Unlike Spanish Red/Blue there is no
      -- shift-matching disassembly to take addresses from, so this manifest
      -- is recovered from the cartridge itself by tools/es/ -- see
      -- tools/es/README.md for how, and for what that costs in confidence.
...
-- disassembly -- now derives them from the cartridge instead.
