...
Pipelines.setLevel("voxel", VoxelState.FULL_LEVEL)
Game.keypressed(keyGame, "3")
T.eq(Pipelines.levelLabel("voxel"), "STEEP",
...
;(function()
  ...
  T.eq(Pipelines.levelLabel("voxel"), "SLIGHT",
    "SELECT steps the VOXEL ladder exactly as 3 does")
  OverworldState.handleInput({})
  T.eq(Pipelines.levelLabel("voxel"), "TILTED", "and keeps walking it")
...
T.eq(VoxelState.ANGLE_LABELS[VoxelState.FP_LEVEL + 1], "1ST PERSON",
